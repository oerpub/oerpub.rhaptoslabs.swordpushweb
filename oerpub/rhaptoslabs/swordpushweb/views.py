...
def oauth2(request):
    ...
    scope = "https://www.googleapis.com/auth/userinfo.profile  https://www.googleapis.com/auth/drive.readonly https://www.googleapis.com/auth/drive.install   "
...
def googlelogin(request):
    ...
    credentials_location = "/root/master/credentials/"+request.session['username']
...
def process_gdocs_resource(save_dir, gdocs_resource_id, username, gdocs_access_token=None):
    ...
    download_url = file_d.get('exportLinks').get('text/html')
    print "FILE ID", file_d
